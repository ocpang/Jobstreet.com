	...
	<div class="panel panel-default">    	
		...
		?>            
            <div class="pull-right">
                <button class="btn btn-primary btn-sm add" title="Tambah" data-toggle="modal" data-target="#modal_user">
        	...
        	<table class="table table-hover table-striped table-condensed" id="table">
				...
				?>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning btn-sm edit" title="Ubah" data-toggle="modal" data-target="#modal_user" id="edit_<?PHP echo $row->idadmin; ?>">
	...
	<div class="modal-dialog">
    	<div class="modal-content">
            ...
            <div class="modal-footer">
            	<button class="btn btn-primary btn-sm" type="submit" form="form_user" id="save">
                	Simpan
                </button>
            	<button class="btn btn-primary btn-sm" type="submit" form="form_user" id="update">
                	Perbaharui
                </button>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.add').click(function(){
			...
			$('#form_user').attr('action','<?PHP echo base_url(); ?>user/save');
		...
		$(".edit").click(function(){
			...
			$('#form_user').attr('action','<?PHP echo base_url(); ?>user/update');
...
//			 	window.location = "<PHP echo base_url(); ?>program_keahlian/" + $("#id_program_keahlian").val();
		...
		$('.excel').click(function() {
			window.location = '<?PHP echo base_url(); ?>user/export/excel';
		});

		$('.pdf').click(function() {
			window.location = '<?PHP echo base_url(); ?>user/export/pdf';
		});
