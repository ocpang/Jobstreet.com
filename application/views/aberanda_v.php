	...
	<div class="container">
		...
		<div class="row">
          ...
          <div class="col-xs-6 col-md-2" align="center">
            <a href="<?php echo base_url(); ?>user" class="thumbnail">
              <img src="<?php echo base_url(); ?>assets/img/user-icon.png" data-src="holder.js/100%x180" alt="..."> User
            </a>
          </div>
          <div class="col-xs-6 col-md-2" align="center">
            <a href="<?php echo base_url(); ?>amember" class="thumbnail">
              <img src="<?php echo base_url(); ?>assets/img/member-icon.png" data-src="holder.js/100%x180" alt="..."> Member
            </a>
          </div>
          <div class="col-xs-6 col-md-2" align="center">
